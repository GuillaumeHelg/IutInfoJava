...
public class TestPileGenInt {
     ...
     */
    private static void testCreationPileVide(PileGenC<Integer> p, String nomPile){
        if (p.estVide()) {
     ...
     */
    private static void testCapacite(PileGenC<Integer> p, PileGenC<Integer> identique, PileGenC<Integer> differente) {
     ...
     */
    private static void testEgalite(PileGenC<Integer> p, PileGenC<Integer> identique, PileGenC<Integer> differente) {
    ...
    private static void testSansException() {
         ...
         */
        try {
            PileGenC<Integer> p = new PileGenC<>(5);                    // pile de référence
            PileGenC<Integer> inverse = new PileGenC<>(5);              // recevra l'inverse de p
            PileGenC<Integer> grandePile = new PileGenC<>(10);          // pour le test sur la capacité
    ...
    private static void testDesExceptions() {
        ...
        try {
            PileGenC<Integer> p = new PileGenC<>(-5);
