...
import ExceptionLaClassePile.Telephone;
import ExceptionLaClassePile.TelephoneC;
...
public class TestPileGenTel {
     ...
     */
    private static void testCreationPileVide(PileGenC<TelephoneC> p, String nomPile){
        if (p.estVide()) {
     ...
     */
    private static void testCapacite(PileGenC<TelephoneC> p, PileGenC<TelephoneC> identique, PileGenC<TelephoneC> differente) {
     ...
     */
    private static void testEgalite(PileGenC<TelephoneC> p, PileGenC<TelephoneC> identique, PileGenC<TelephoneC> differente) {
    ...
    private static void testSansException() {
        ...
        TelephoneC num = new TelephoneC("0680427499");
        TelephoneC num1 = new TelephoneC("0565442155");
        TelephoneC num2 = new TelephoneC("0745658595");
         ...
         */
        try {
            PileGenC<TelephoneC> p = new PileGenC<>(5);                    // pile de référence
            PileGenC<TelephoneC> inverse = new PileGenC<>(15);              // recevra l'inverse de p
            PileGenC<TelephoneC> grandePile = new PileGenC<>(6);          // pour le test sur la capacité
    ...
    private static void testDesExceptions() {
        ...
        try {
            PileGenC<TelephoneC> p = new PileGenC<>(-5);
